...
abstract class Vehicles implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\VehiclesTableMap';
    ...
    /**
     * The value for the in_service field.
     *
     * @var        boolean
     */
    protected $in_service;
    ...
    /**
     * Initializes internal state of Base\Vehicles object.
     */
     ...
     *
     * @return $this|Vehicles The current object, for fluid interface
     */
    ...
    /**
     * Get the [in_service] column value.
     *
     * @return boolean
     */
     ...
     * @return $this|\Vehicles The current object (for fluent API support)
     */
    public function setVehicleId($v)
    {
        ...
        if ($this->vehicle_id !== $v) {
            $this->vehicle_id = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_VEHICLE_ID] = true;
        }
    ...
    public function setMake($v)
    {
        ...
        if ($this->make !== $v) {
            $this->make = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_MAKE] = true;
        }
    ...
    public function setModel($v)
    {
        ...
        if ($this->model !== $v) {
            $this->model = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_MODEL] = true;
        }
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== $v) {
            $this->year = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_YEAR] = true;
        }
    ...
    public function setVin($v)
    {
        ...
        if ($this->vin !== $v) {
            $this->vin = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_VIN] = true;
        }
    ...
    public function setMileage($v)
    {
        ...
        if ($this->mileage !== $v) {
            $this->mileage = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_MILEAGE] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_TYPE] = true;
        }
    ...
    public function setLicensePlate($v)
    {
        ...
        if ($this->license_plate !== $v) {
            ...
            $this->modifiedColumns[VehiclesTableMap::COL_LICENSE_PLATE] = true;
        }
    ...
    public function setStationId($v)
    {
        ...
        if ($this->station_id !== $v) {
            $this->station_id = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_STATION_ID] = true;
        }
    ...
    /**
     * Sets the value of the [in_service] column.
     ...
     * @return $this|\Vehicles The current object (for fluent API support)
     */
    public function setInService($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->in_service !== $v) {
            $this->in_service = $v;
            $this->modifiedColumns[VehiclesTableMap::COL_IN_SERVICE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VehiclesTableMap::translateFieldName('VehicleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vehicle_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VehiclesTableMap::translateFieldName('Make', TableMap::TYPE_PHPNAME, $indexType)];
            $this->make = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VehiclesTableMap::translateFieldName('Model', TableMap::TYPE_PHPNAME, $indexType)];
            $this->model = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VehiclesTableMap::translateFieldName('Year', TableMap::TYPE_PHPNAME, $indexType)];
            $this->year = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VehiclesTableMap::translateFieldName('Vin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VehiclesTableMap::translateFieldName('Mileage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mileage = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : VehiclesTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : VehiclesTableMap::translateFieldName('LicensePlate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->license_plate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : VehiclesTableMap::translateFieldName('StationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->station_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : VehiclesTableMap::translateFieldName('InService', TableMap::TYPE_PHPNAME, $indexType)];
            $this->in_service = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 10; // 10 = VehiclesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Vehicles'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VehiclesTableMap::COL_VEHICLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'vehicle_id';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MAKE)) {
            $modifiedColumns[':p' . $index++]  = 'make';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MODEL)) {
            $modifiedColumns[':p' . $index++]  = 'model';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_YEAR)) {
            $modifiedColumns[':p' . $index++]  = 'year';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_VIN)) {
            $modifiedColumns[':p' . $index++]  = 'vin';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MILEAGE)) {
            $modifiedColumns[':p' . $index++]  = 'mileage';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_LICENSE_PLATE)) {
            $modifiedColumns[':p' . $index++]  = 'license_plate';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_STATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'station_id';
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_IN_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = 'in_service';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'type':
                        ...
                        break;
                    case 'license_plate':
                        $stmt->bindValue($identifier, $this->license_plate, PDO::PARAM_STR);
                        break;
                    case 'station_id':
                        $stmt->bindValue($identifier, $this->station_id, PDO::PARAM_INT);
                        break;
                    case 'in_service':
                        $stmt->bindValue($identifier, (int) $this->in_service, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getType(),
            $keys[7] => $this->getLicensePlate(),
            $keys[8] => $this->getStationId(),
            $keys[9] => $this->getInService(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setVin($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setMileage($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setType($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setLicensePlate($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setStationId($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setInService($arr[$keys[9]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VehiclesTableMap::COL_VEHICLE_ID)) {
            $criteria->add(VehiclesTableMap::COL_VEHICLE_ID, $this->vehicle_id);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MAKE)) {
            $criteria->add(VehiclesTableMap::COL_MAKE, $this->make);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MODEL)) {
            $criteria->add(VehiclesTableMap::COL_MODEL, $this->model);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_YEAR)) {
            $criteria->add(VehiclesTableMap::COL_YEAR, $this->year);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_VIN)) {
            $criteria->add(VehiclesTableMap::COL_VIN, $this->vin);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_MILEAGE)) {
            $criteria->add(VehiclesTableMap::COL_MILEAGE, $this->mileage);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_TYPE)) {
            $criteria->add(VehiclesTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_LICENSE_PLATE)) {
            $criteria->add(VehiclesTableMap::COL_LICENSE_PLATE, $this->license_plate);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_STATION_ID)) {
            $criteria->add(VehiclesTableMap::COL_STATION_ID, $this->station_id);
        }
        if ($this->isColumnModified(VehiclesTableMap::COL_IN_SERVICE)) {
            $criteria->add(VehiclesTableMap::COL_IN_SERVICE, $this->in_service);
        }
    ...
    {
        $validPk = null !== $this->getVehicleId();
    ...
    /**
     * Generic method to set the primary key (vehicle_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Vehicles (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setInService($this->getInService());
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setVehicleId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Vehicles Clone of current object.
     * @throws PropelException
     */
    ...
    public function getStation(ConnectionInterface $con = null)
    {
        if ($this->aStation === null && ($this->station_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStation->addVehicless($this);
             */
        }
    ...
    {
        if (null !== $this->aStation) {
            $this->aStation->removeVehicles($this);
        }
