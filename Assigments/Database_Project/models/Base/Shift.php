...
/**
 * Base class that represents a row from the 'shift' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Shift implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShiftTableMap';
    ...
    /**
     * The value for the shift_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\Shift object.
     */
    ...
    /**
     * Compares this with another <code>Shift</code> instance.  If
     * <code>obj</code> is an instance of <code>Shift</code>, delegates to
     * <code>equals(Shift)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Shift The current object, for fluid interface
     */
    ...
    /**
     * Get the [shift_name] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Shift The current object (for fluent API support)
     */
    public function setShiftId($v)
    {
        ...
        if ($this->shift_id !== $v) {
            $this->shift_id = $v;
            $this->modifiedColumns[ShiftTableMap::COL_SHIFT_ID] = true;
        }
    ...
    /**
     * Set the value of [shift_name] column.
     *
     * @param string $v new value
     * @return $this|\Shift The current object (for fluent API support)
     */
    public function setShiftName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->shift_name !== $v) {
            $this->shift_name = $v;
            $this->modifiedColumns[ShiftTableMap::COL_SHIFT_NAME] = true;
        }
    ...
    public function setStationId($v)
    {
        ...
        if ($this->station_id !== $v) {
            $this->station_id = $v;
            $this->modifiedColumns[ShiftTableMap::COL_STATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShiftTableMap::translateFieldName('ShiftId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shift_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShiftTableMap::translateFieldName('ShiftName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shift_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShiftTableMap::translateFieldName('StationId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ShiftTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Shift'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShiftQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildShiftQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShiftTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ShiftTableMap::COL_SHIFT_ID] = true;
        if (null !== $this->shift_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ShiftTableMap::COL_SHIFT_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ShiftTableMap::COL_SHIFT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'shift_id';
        }
        if ($this->isColumnModified(ShiftTableMap::COL_SHIFT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'shift_name';
        }
        if ($this->isColumnModified(ShiftTableMap::COL_STATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'station_id';
        }

        $sql = sprintf(
            'INSERT INTO shift (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'shift_id':
                        ...
                        break;
                    case 'shift_name':
                        $stmt->bindValue($identifier, $this->shift_name, PDO::PARAM_STR);
                        break;
                    case 'station_id':
    ...
    {
        $pos = ShiftTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Shift'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Shift'][$this->hashCode()] = true;
        $keys = ShiftTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getShiftId(),
            $keys[1] => $this->getShiftName(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setShiftId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setShiftName($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShiftTableMap::COL_SHIFT_ID)) {
            $criteria->add(ShiftTableMap::COL_SHIFT_ID, $this->shift_id);
        }
        if ($this->isColumnModified(ShiftTableMap::COL_SHIFT_NAME)) {
            $criteria->add(ShiftTableMap::COL_SHIFT_NAME, $this->shift_name);
        }
        if ($this->isColumnModified(ShiftTableMap::COL_STATION_ID)) {
            $criteria->add(ShiftTableMap::COL_STATION_ID, $this->station_id);
        }
    ...
    {
        $criteria = ChildShiftQuery::create();
        $criteria->add(ShiftTableMap::COL_SHIFT_ID, $this->shift_id);
    ...
    /**
     * Generic method to set the primary key (shift_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Shift (or compatible) type.
    ...
    {
        $copyObj->setShiftName($this->getShiftName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setShiftId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Shift Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildShift is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildShift The current object (for fluent API support)
     */
    public function setPersonnels(Collection $personnels, ConnectionInterface $con = null)
    {
        ...
        foreach ($personnelsToDelete as $personnelRemoved) {
            $personnelRemoved->setShift(null);
        }
     ...
     * Otherwise if this Shift is new, it will return
     * an empty collection; or if this Shift has previously
     * been saved, it will retrieve related Personnels from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Shift.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aStation) {
            $this->aStation->removeShift($this);
        }
        $this->shift_id = null;
    ...
    {
        return (string) $this->exportTo(ShiftTableMap::DEFAULT_STRING_FORMAT);
    }
