...
/**
 * Base class that represents a row from the 'certifications' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Certifications implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CertificationsTableMap';
    ...
    /**
     * The value for the certification_number field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\Certifications object.
     */
    ...
    /**
     * Compares this with another <code>Certifications</code> instance.  If
     * <code>obj</code> is an instance of <code>Certifications</code>, delegates to
     * <code>equals(Certifications)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Certifications The current object, for fluid interface
     */
    ...
    /**
     * Get the [certification_number] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Certifications The current object (for fluent API support)
     */
    public function setCertificationId($v)
    {
        ...
        if ($this->certification_id !== $v) {
            ...
            $this->modifiedColumns[CertificationsTableMap::COL_CERTIFICATION_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CertificationsTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [certification_number] column.
     *
     * @param string $v new value
     * @return $this|\Certifications The current object (for fluent API support)
     */
    public function setCertificationNumber($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->certification_number !== $v) {
            $this->certification_number = $v;
            $this->modifiedColumns[CertificationsTableMap::COL_CERTIFICATION_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CertificationsTableMap::translateFieldName('CertificationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->certification_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CertificationsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CertificationsTableMap::translateFieldName('CertificationNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->certification_number = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CertificationsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Certifications'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCertificationsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Certifications::setDeleted()
     * @see Certifications::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCertificationsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CertificationsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CertificationsTableMap::COL_CERTIFICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'certification_id';
        }
        if ($this->isColumnModified(CertificationsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(CertificationsTableMap::COL_CERTIFICATION_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'certification_number';
        }

        $sql = sprintf(
            'INSERT INTO certifications (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'certification_number':
                        $stmt->bindValue($identifier, $this->certification_number, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = CertificationsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getCertificationNumber();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Certifications'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Certifications'][$this->hashCode()] = true;
        $keys = CertificationsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCertificationId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getCertificationNumber(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setCertificationNumber($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCertificationId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setName($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCertificationNumber($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CertificationsTableMap::COL_CERTIFICATION_ID)) {
            $criteria->add(CertificationsTableMap::COL_CERTIFICATION_ID, $this->certification_id);
        }
        if ($this->isColumnModified(CertificationsTableMap::COL_NAME)) {
            $criteria->add(CertificationsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(CertificationsTableMap::COL_CERTIFICATION_NUMBER)) {
            $criteria->add(CertificationsTableMap::COL_CERTIFICATION_NUMBER, $this->certification_number);
        }
    ...
    {
        $criteria = ChildCertificationsQuery::create();
        $criteria->add(CertificationsTableMap::COL_CERTIFICATION_ID, $this->certification_id);
    ...
    {
        $validPk = null !== $this->getCertificationId();
    ...
    /**
     * Generic method to set the primary key (certification_id column).
     *
    ...
    {
        return null === $this->getCertificationId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Certifications (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCertificationNumber($this->getCertificationNumber());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCertificationId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Certifications Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCertifications is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCertifications The current object (for fluent API support)
     */
    public function setPersonnels(Collection $personnels, ConnectionInterface $con = null)
    {
        ...
        foreach ($personnelsToDelete as $personnelRemoved) {
            $personnelRemoved->setCertifications(null);
        }
    ...
    protected function doAddPersonnel(ChildPersonnel $personnel)
    {
        ...
        $personnel->setCertifications($this);
    }
    ...
    public function removePersonnel(ChildPersonnel $personnel)
    {
        if ($this->getPersonnels()->contains($personnel)) {
            ...
            $personnel->setCertifications(null);
        }
     ...
     * Otherwise if this Certifications is new, it will return
     * an empty collection; or if this Certifications has previously
     * been saved, it will retrieve related Personnels from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Certifications.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPersonnel[] List of ChildPersonnel objects
     */
    public function getPersonnelsJoinStation(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPersonnelQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->name = null;
        $this->certification_number = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(CertificationsTableMap::DEFAULT_STRING_FORMAT);
    }
