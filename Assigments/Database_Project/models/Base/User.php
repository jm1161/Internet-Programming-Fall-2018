...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setStationId($v)
    {
        ...
        if ($this->station_id !== $v) {
            $this->station_id = $v;
            $this->modifiedColumns[UserTableMap::COL_STATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('StationId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_STATION_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_STATION_ID)) {
            $criteria->add(UserTableMap::COL_STATION_ID, $this->station_id);
        }
        if ($this->isColumnModified(UserTableMap::COL_ADMIN)) {
