...
abstract class Inventory implements ActiveRecordInterface
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[InventoryTableMap::COL_NAME] = true;
        }
    ...
    public function setBrand($v)
    {
        ...
        if ($this->brand !== $v) {
            $this->brand = $v;
            $this->modifiedColumns[InventoryTableMap::COL_BRAND] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[InventoryTableMap::COL_TYPE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[InventoryTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setItemCondition($v)
    {
        ...
        if ($this->item_condition !== $v) {
            $this->item_condition = $v;
            $this->modifiedColumns[InventoryTableMap::COL_ITEM_CONDITION] = true;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[InventoryTableMap::COL_QUANTITY] = true;
        }
    ...
    public function setStationId($v)
    {
        ...
        if ($this->station_id !== $v) {
            $this->station_id = $v;
            $this->modifiedColumns[InventoryTableMap::COL_STATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InventoryTableMap::translateFieldName('InventoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inventory_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InventoryTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InventoryTableMap::translateFieldName('Brand', TableMap::TYPE_PHPNAME, $indexType)];
            $this->brand = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InventoryTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InventoryTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InventoryTableMap::translateFieldName('ItemCondition', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_condition = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InventoryTableMap::translateFieldName('Quantity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quantity = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InventoryTableMap::translateFieldName('StationId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = InventoryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InventoryTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_BRAND)) {
            $modifiedColumns[':p' . $index++]  = 'brand';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_ITEM_CONDITION)) {
            $modifiedColumns[':p' . $index++]  = 'item_condition';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_QUANTITY)) {
            $modifiedColumns[':p' . $index++]  = 'quantity';
        }
        if ($this->isColumnModified(InventoryTableMap::COL_STATION_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getInventoryId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getBrand(),
            $keys[3] => $this->getType(),
            $keys[4] => $this->getDescription(),
            $keys[5] => $this->getItemCondition(),
            $keys[6] => $this->getQuantity(),
            $keys[7] => $this->getStationId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setInventoryId($arr[$keys[0]]);
        }
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setItemCondition($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setQuantity($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setStationId($arr[$keys[7]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InventoryTableMap::COL_NAME)) {
            $criteria->add(InventoryTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_BRAND)) {
            $criteria->add(InventoryTableMap::COL_BRAND, $this->brand);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_TYPE)) {
            $criteria->add(InventoryTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_DESCRIPTION)) {
            $criteria->add(InventoryTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_ITEM_CONDITION)) {
            $criteria->add(InventoryTableMap::COL_ITEM_CONDITION, $this->item_condition);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_QUANTITY)) {
            $criteria->add(InventoryTableMap::COL_QUANTITY, $this->quantity);
        }
        if ($this->isColumnModified(InventoryTableMap::COL_STATION_ID)) {
            $criteria->add(InventoryTableMap::COL_STATION_ID, $this->station_id);
        }
    ...
    {
        $validPk = null !== $this->getInventoryId();
    ...
    {
        return null === $this->getInventoryId();
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setInventoryId(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function getStation(ConnectionInterface $con = null)
    {
        if ($this->aStation === null && ($this->station_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStation->addInventories($this);
             */
        }
    ...
    {
        if (null !== $this->aStation) {
            $this->aStation->removeInventory($this);
        }
