...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_STATION_ID = 'user.station_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'UserName', 'UserPassword', 'StationId', 'Admin', ),
        self::TYPE_CAMELNAME     => array('userId', 'userName', 'userPassword', 'stationId', 'admin', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_USER_NAME, UserTableMap::COL_USER_PASSWORD, UserTableMap::COL_STATION_ID, UserTableMap::COL_ADMIN, ),
        self::TYPE_FIELDNAME     => array('user_id', 'user_name', 'user_password', 'station_id', 'admin', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'UserName' => 1, 'UserPassword' => 2, 'StationId' => 3, 'Admin' => 4, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'userName' => 1, 'userPassword' => 2, 'stationId' => 3, 'admin' => 4, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_USER_NAME => 1, UserTableMap::COL_USER_PASSWORD => 2, UserTableMap::COL_STATION_ID => 3, UserTableMap::COL_ADMIN => 4, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'user_name' => 1, 'user_password' => 2, 'station_id' => 3, 'admin' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_STATION_ID);
