...
class PersonTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PersonTableMap::COL_ID, PersonTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PersonTableMap::COL_ID => 0, PersonTableMap::COL_NAME => 1, ),
    ...
    {
        $this->addRelation('PhoneNumbers', '\\PhoneNumbers', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':person_id',
    1 => ':id',
  ),
), null, null, 'PhoneNumberss', false);
    } // buildRelations()
